...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/james007-droid/SSHPLUS/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/james007-droid/SSHPLUS/main/badvpn/antcrashvpn.sh -o /dev/null
